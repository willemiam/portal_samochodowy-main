"""
Comprehensive test suite for the Flask marketplace application.
Contains 14 tests covering all major functionality.
"""
...
class TestAppFunctionality:
    ...
    def test_database_initialization_with_csv(self, app_context, mock_csv_file):
    ...
    def test_database_initialization_missing_csv(self, app_context):
    ...
    def test_create_user_success(self, client, app_context):
    ...
    def test_get_all_users(self, client, app_context):
    ...
    def test_get_user_by_id(self, client, app_context):
    ...
    def test_create_item_success(self, client, app_context):
    ...
    def test_get_all_items(self, client, app_context):
    ...
    def test_filter_items_by_make(self, client, app_context):
    ...
    def test_get_car_makes(self, client, app_context):
    ...
    def test_get_car_models_by_make(self, client, app_context):
    ...
    def test_invalid_filter_year(self, client):
